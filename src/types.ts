...
export interface SchedulePreferences {
  ...
  /** Legacy/display labels for mandatory courses. */
  mandatoryCourses: string[];
  /** Stable course identities that MUST be included in every generated schedule. */
...
export interface OptimizerOutput {
  ...
  allRankedSchedules: OptimizationResult[];
  byDayCount: {
