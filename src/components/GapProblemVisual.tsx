...
export const GapProblemVisual: React.FC = () => {
  return (
    <div
      ...
      aria-label="A course at 10 AM followed by a three hour gap before the next course at 1 PM"
    >
      ...
      <div className="mt-6 grid grid-cols-[auto_1fr_auto] items-center gap-3 sm:gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm sm:text-base font-extrabold text-ink">Course</p>
        </div>
        ...
        <div className="min-w-0" aria-hidden="true">
          ...
          <div className="mt-2 border-y border-line py-3 sm:py-4 text-center bg-mist">
            <p className="font-mono text-lg sm:text-2xl font-black text-ink">3 hours</p>
      ...
      <p className="mt-4 text-sm sm:text-base leading-relaxed text-text-secondary">
        Gadwal looks through the available sections and finds combinations with less waiting time between courses.
      </p>
    </div>
  );
};
