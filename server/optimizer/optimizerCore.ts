import { DayOfWeek, OptimizationResult, Session } from '../../src/types';
import { parseTimeToMinutes, normalizeTimeToHHMM } from '../../src/domain/time';
import { resolveDayTokens } from '../../src/utils/scheduleParsing';

export { parseTimeToMinutes, normalizeTimeToHHMM };
 ...
 * Ranking itself lives in optimizer.ts so result ordering stays deterministic and consistent.
 */
