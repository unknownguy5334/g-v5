...
const checks=[
  ...
  [!child.includes("addEventListener('online'") && !child.includes('addEventListener(\"online\"') && child.includes('const handleRetryFailed = () =>') && child.includes('Retrying the complete screenshot set.'),'offline recovery remains explicit and user-triggered rather than auto-retrying on network restoration'],
