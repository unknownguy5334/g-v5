...
ok((add.includes('onDeleteSection(section.id, group.courseName)') || add.includes('setDetailsSectionDeleteTarget({') || add.includes('Remove section')), 'every saved section has its own delete action');
