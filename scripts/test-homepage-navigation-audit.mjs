...
assert(hero.includes('{COPY.hero.title}'), 'Hero renders the canonical title copy.');
assert(hero.includes('{COPY.hero.line1}'), 'Hero renders the canonical first problem line.');
assert(hero.includes('{COPY.hero.line2}'), 'Hero renders the canonical second problem line.');
assert(hero.includes('{COPY.hero.resolution}'), 'Hero renders the canonical solution copy.');
assert(hero.includes('<StudentGapPosts />'), 'Hero uses student posts as the primary visual.');
...
assert(app.includes('>Screenshot guide<'), 'Homepage footer keeps screenshot guide CTA.');
assert(app.includes('>How it works<'), 'Homepage footer keeps how-it-works CTA.');
assert(app.includes('Access & billing'), 'Homepage footer exposes permanent Access & billing information.');
